...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        coarse_answer_key: Optional[str] = None,
        intensity_answer_key: Optional[str] = None,
        ...
        self.coarse_answer_key = coarse_answer_key
        self.intensity_answer_key = intensity_answer_key
    ...
    def __getitem__(self, index):
        ...
        if self.coarse_answer_key is not None and self.coarse_answer_key in example:
            example["ground_truth_coarse"] = example.pop(self.coarse_answer_key)
        if self.intensity_answer_key is not None and self.intensity_answer_key in example:
            example["ground_truth_intensity"] = example.pop(self.intensity_answer_key)
        return example
