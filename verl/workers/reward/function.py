...
class SequentialFunctionRewardManager(FunctionRewardManager):
    ...
    def compute_reward(self, data: DataProto) -> Tuple[torch.Tensor, Dict[str, List[float]]]:
        ...
        for i in range(len(data)):
            ...
            if "ground_truth_coarse" in data.non_tensor_batch:
                reward_input["ground_truth_coarse"] = data.non_tensor_batch["ground_truth_coarse"][i]
            if "ground_truth_intensity" in data.non_tensor_batch:
                reward_input["ground_truth_intensity"] = data.non_tensor_batch["ground_truth_intensity"][i]
