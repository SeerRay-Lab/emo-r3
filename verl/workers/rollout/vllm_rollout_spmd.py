...
class vLLMRollout(BaseRollout):
    def __init__(
        ...
        sampling_kwargs = {
            ...
            "logprobs": config.logprobs if hasattr(config, "logprobs") else 10,  # Return top-10 logprobs
        }
    ...
    def generate_sequences(self, prompts: DataProto) -> DataProto:
        ...
        with self.update_sampling_params(**prompts.meta_info):
            ...
            if self.sampling_params.n > 1:
                ...
                # Note: response_logprobs is already expanded since we iterate through all outputs
