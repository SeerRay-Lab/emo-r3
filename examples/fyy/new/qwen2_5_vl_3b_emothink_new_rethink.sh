...
EXPERIMENT_NAME=qwen2_5_vl_3b_emotion6_${ROLLOUT_NUMBER}_grpo_emothink_rethink
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=./examples/reward_function/new/emothink_rethink.py:compute_score \
