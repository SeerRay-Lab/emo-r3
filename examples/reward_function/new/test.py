...
response = """<step1>Describe the overall atmosphere and its emotional tone.</step1>
The overall atmosphere in the image is dark and somewhat eerie, with a dimly lit background that adds to the mysterious and unsettling mood.

<step2>Describe the main subject or event and its emotional influence.</step2>
The main subject is a person with a dramatic and unusual hairstyle, featuring a mix of black and blue hair. Their facial expression is exaggerated, with wide eyes and a slightly open mouth, which adds to the eerie and unsettling atmosphere.

<step3>Integrate the above and summarize the overall emotion.</step3>
Given the dark and eerie atmosphere, the dramatic hairstyle, and the exaggerated facial expression, the overall emotion conveyed in the image is **disgust**. The combination of the unusual appearance and the dark setting creates a sense of unease and discomfort.

\boxed{disgust}"""


ground_truth = "excitement"
emo_score = emo_reward(response, ground_truth)
print(emo_score)
