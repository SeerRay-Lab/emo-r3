...
# bash examples/emo/new0817/ps_grpo/qwen2_5_vl_3b_naive_grpo.sh
...
RUN_FOLDER="/workspace/easyr1_self/examples/emo/new0817/ps_grpo/run_${TIMESTAMP}"
mkdir -p "${RUN_FOLDER}"

# Copy this script to the run folder
cp "/workspace/easyr1_self/examples/emo/new0817/ps_grpo/qwen2_5_vl_3b_naive_grpo.sh" "${RUN_FOLDER}/"

# Copy config file to the run folder
cp "/workspace/easyr1_self/examples/emo/new0817/ps_grpo/config.yaml" "${RUN_FOLDER}/"

# Read paths from config file
CONFIG_FILE="/workspace/easyr1_self/examples/emo/new0817/ps_grpo/config.yaml"
